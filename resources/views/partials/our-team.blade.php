        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 text-center text-md-left">
                <p class="heading_space">
                    {{ __('We are a team of professionals with IT experience in various fields, which is constantly evolving and, accordingly, expands the range of services offered') }}
                </p>
            </div>
        </div>
