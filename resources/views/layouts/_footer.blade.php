                ...
                <div class="footer_panel padding_bottom_half bottom20">
                    ...
                    <div class="d-table w-100 address-item whitecolor bottom25">
                        ...
                        <p class="d-table-cell align-middle bottom0">
                            +998 97 750-00-04, <a class="d-block" href="mailto:info@napaautomotive.com">info@napaautomotive.com</a>
                        </p>
                    </div>
                    <ul class="social-icons white wow fadeInUp" data-wow-delay="300ms">
                        <li>
                            <a href="https://facebook.com/NapaAutomotive">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                        </li>
                        <li>
                            <a href="https://youtube.com/channel/UC8Q8q_I258NsrU3jq_6MzmQ">
                        ...
                        <li>
                            <a href="https://instagram.com/napa_automotive">
