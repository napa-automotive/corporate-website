                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-9 col-sm-12">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('testimonial') }}">Отзывы</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <li class="nav-item  position-relative">
                                <a class="nav-link" href="{{ route('project') }}" aria-haspopup="true"
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer_panel padding_bottom_half bottom20">
                            <a href="" class="footer_logo bottom25"><img src="images/logo-transparent.png"
                                    alt="trax"></a>
                            <p class="whitecolor bottom25">Индивидуальное решение для ваших цифровых нужд</p>
                            <div class="d-table w-100 address-item whitecolor bottom25">
                                <span class="d-table-cell align-middle"><i class="fas fa-mobile-alt"></i></span>
                                <p class="d-table-cell align-middle bottom0">
                                    +998 97 750-00-04, <a class="d-block"
                                        href="mailto:umid.abdusattorov@me.com">info@napaautomotive.com</a>
                                </p>
                            </div>
                            <ul class="social-icons white wow fadeInUp" data-wow-delay="300ms">
                                <li><a href="https://www.facebook.com/NapaAutomotive"><i class="fab fa-facebook-f"></i>
                                    </a> </li>
                                <li><a href="https://youtube.com/channel/UC8Q8q_I258NsrU3jq_6MzmQ">
                                    <i class="fab fa-youtube"></i> </a> </li>
                                <li><a href="javascript:void(0)"><i class="fab fa-linkedin-in"></i> </a> </li>
                                <li><a href="https://www.instagram.com/napa_automotive/?hl=ru">
