            ...
            <div class="item testi-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 offset-lg-2 col-md-10 offset-md-1 text-lg-left text-center">
                        <p class="bottom15 top90">В настоящее время мы являемся партнерами-исполнителями государственного&nbsp; предприятия «Уз Авто Саноат» по проекту «Автоматизация Бизнес процессов»</p>
           ...
           <!--  <div class="item testi-box">
            ...
            <div class="item testi-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 offset-lg-2 col-md-10 offset-md-1 text-lg-left text-center">
                        <p class="bottom15 top90">Мы используем самые современные технологии для разработки программного обеспечения.</p>
                        <span class="d-inline-block test-star">
                                <i class="fas fa-star"></i> <i class="fas fa-star"></i> <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i> <i class="fas fa-star"></i>
                                </span>
