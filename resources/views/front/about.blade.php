        ...
        <div class="container aboutus">
            ...
            <div class="row  align-items-center">
                <div class="col-lg-5  col-md-6 padding_top_half text-center text-md-left">
                    <h2 class="darkcolor font-normal bottom30">Лучший набор навыков, доступный в <span class="defaultcolor">нашей компании</span> </h2>
                    <p class="bottom35">Для разработки сайтов и приложении - PHP,Python, .NET и Java и самые современные технологии Bootstrap и React, VUE, Angular, позволяющие создавать интернет-приложения, пригодные к работе на любых видах устройств. </p>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="heading-title wow fadeInUp text-center text-md-left" data-wow-delay="300ms">
                        ...
                        <h2 class="darkcolor bottom30 font-normal">Познакомьтесь с нашей командой</h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 text-center text-md-left">
                    <p class="heading_space">Мы команда профессионалов, имеющая ИТ опыт в различных сферах, которая постоянно развивается и соответственно, расширяет спектр предлагаемых услуг </p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="team-box">
                                ...
                                <div class="team-content">
                                    ...
                                    <ul class="social-icons-simple">
                                        <li><a class="facebook" href="https://www.facebook.com/NapaAutomotive"><i class="fab fa-facebook-f"></i> </a> </li>
