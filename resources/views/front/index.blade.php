...
<section id="main-banner-area" class="position-relative">
    ...
    <ul class="social-icons-simple revicon white">
        <li class="d-table"><a href="https://www.facebook.com/NapaAutomotive"><i class="fab fa-facebook-f"></i></a> </li>
        <li class="d-table"><a href="https://youtube.com/channel/UC8Q8q_I258NsrU3jq_6MzmQ"><i class="fab fa-youtube"></i> </a> </li>
        <li class="d-table"><a href="http://www.napaautomotive.uz"><i class="fab fa-linkedin-in"></i> </a> </li>
        <li class="d-table"><a href="https://www.instagram.com/napa_automotive/?hl=ru"><i class="fab fa-instagram"></i> </a> </li>
    </ul>
</section>
<!--Main Slider ends -->
<!--Some Services-->
        ...
        <div class="row d-flex align-items-center">
            <div class="col-lg-6 col-md-7 col-sm-7 text-sm-left text-center wow fadeInLeft" data-wow-delay="300ms">
                <div class="heading-title mb-4">
                    <h2 class="darkcolor font-normal bottom30"> Поднимем ваш<span class="defaultcolor"> бизнес</span> на новый уровень</h2>
                </div>
                <p class="bottom35">Мы команда профессионалов, имеющая ИТ опыт в различных сферах, которая постоянно развивается и соответственно, расширяет спектр предлагаемых услуг. Благодаря глубокому изучению и пониманию потребностей наших клиентов, высокой квалификации специалистов, постоянному совершенствованию своих навыков мы предлагаем свои услуги на профессиональном уровне по оптимальной цене.</p>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <div class="heading-title whitecolor wow fadeInUp" data-wow-delay="300ms">
                    <span>Внедрение комплексных программных и аппаратных IT cистем включает в себя следующие этапы: </span>
    ...
    <div class="container">
        <div class="row align-items-center text-center">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <p class="whitecolor top20 bottom20 font-light title">Мы, молодая и амбициозная стартап команда, позиционируемся на рынке как системный IT интегратор </p>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                <div class="counters whitecolor top10 bottom10">
                ...
                <div class="col-md-12 col-sm-12">
                    <form class="getin_form wow fadeInUp" data-wow-delay="400ms" onsubmit="return false;">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <button type="submit" class="button gradient-btn w-100" id="submit_btn">Отправить</button>
                            </div>
                        </div>
                    </form>
                </div>
