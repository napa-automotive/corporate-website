...
<section id="main-banner-area" class="position-relative">
            ...
            <ul>
                ...
                <li data-index="rs-02" data-transition="fade" data-slotamount="default" data-easein="Power3.easeInOut"
                    ...
                    <div class="tp-caption tp-resizeme" data-x="['center','center','center','center']"
                        ...
                        data-responsive_offset="on" data-start="2000"
                        data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":2000,"ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'>
                        <!-- <h4 class="blackcolor font-xlight text-center">Responsive and Retina Ready for All Devices</h4> -->
                    </div>
                </li>
                <!-- SLIDE 3 -->
    ...
    <ul class="social-icons-simple revicon white">
        <li class="d-table"><a href="https://www.facebook.com/NapaAutomotive"><i class="fab fa-facebook-f"></i></a>
        </li>
        <li class="d-table"><a href="https://youtube.com/channel/UC8Q8q_I258NsrU3jq_6MzmQ"><i
                    class="fab fa-youtube"></i> </a> </li>
        <li class="d-table"><a href="http://www.napaautomotive.uz"><i class="fab fa-linkedin-in"></i> </a> </li>
        <li class="d-table"><a href="https://www.instagram.com/napa_automotive/?hl=ru"><i class="fab fa-instagram"></i>
            </a> </li>
    </ul>
</section>
<!--Main Slider ends -->
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
                <div class="heading-title whitecolor wow fadeInUp" data-wow-delay="300ms">
                    <span>Внедрение комплексных программных и аппаратных IT cистем включает в себя следующие этапы:
                    </span>
        ...
        <div class="row">
            <ul class="process-wrapp">
                <li class="whitecolor wow fadeIn" data-wow-delay="300ms">
                    ...
                    <p class="mt-n2 mt-sm-0">Сбор требований/Оценка и планирование работ</p>
                </li>
                <li class="whitecolor wow fadeIn" data-wow-delay="400ms">
                    <span class="pro-step bottom20">02</span>
                    <p class="fontbold bottom25">ТЗ</p>
                    <p class="mt-n2 mt-sm-0">Разработка технического задания и спецификаций</p>
                </li>
                <li class="whitecolor wow fadeIn active" data-wow-delay="500ms">
                    <span class="pro-step bottom20">03</span>
                    <p class="fontbold bottom25">Разработка</p>
                    <p class="mt-n2 mt-sm-0"> Разработка интерфейсов/Написание кода</p>
                </li>
                <li class="whitecolor wow fadeIn" data-wow-delay="600ms">
                    <span class="pro-step bottom20">04</span>
                    <p class="fontbold bottom25">Тестирование</p>
                    <p class="mt-n2 mt-sm-0">Контроль качества разрабатываемого приложения</p>
                </li>
                <li class="whitecolor wow fadeIn" data-wow-delay="700ms">
                    <span class="pro-step bottom20">05</span>
                    <p class="fontbold bottom25">Сопровождение системы </p>
                    <p class="mt-n2 mt-sm-0">Вторая и третья линии технической поддержки</p>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-5 col-sm-12">
                <p class="text-center text-md-left">Мы используем самые современные технологии для разработки
                    программного обеспечения и организации производственного процесса</p>
            </div>
        </div>
                ...
                <div class="text-center text-md-right">
                    <div class="feature-item mt-3 wow fadeInLeft" data-wow-delay="300ms"
                        ...
                        <div class="text">
                            ...
                            <p>• Набор используемых технологий весьма широк, но при этом он индивидуально подбирается с
                                учетом потребностей каждого конкретного проекта.</p>
                            <p>• Например, СУБД - классические MS SQL Server, Oracle и достаточно новые - MongoDB и пр.,
                                обеспечивающие надежное хранение и быстрый доступ к данным.</p>
                        </div>
                    </div>
                ...
                <div class="text-center text-md-left">
                    ...
                    <div class="feature-item mt-5 wow fadeInRight" data-wow-delay="350ms"
                        ...
                        <div class="text">
                            ...
                            <p>•Заказчик постоянно находится в курсе последних событий по разработке своего проекта, он
                                может в любой момент проверить работу последних изменений, доставляемых к нему
                                автоматически, посмотреть какие задачи по его проекту уже сделаны, а какие выполняются в
                                настоящее время; какие документы были созданы либо изменены.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center text-center">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <p class="whitecolor top20 bottom20 font-light title">Мы, молодая и амбициозная стартап команда,
                    позиционируемся на рынке как системный IT интегратор </p>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                <div class="counters whitecolor top10 bottom10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <button type="submit" class="button gradient-btn w-100"
                                    id="submit_btn">Отправить</button>
                            </div>
                        </div>
                    </form>
                </div>
